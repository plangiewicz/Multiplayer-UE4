...
#include "FFTP_CarryObjectComponent.generated.h"

/**
 * 
 */
UCLASS(ClassGroup = (FFTP), meta = (BlueprintSpawnableComponent))
class FURYFUNTALEPROD_API UFFTP_CarryObjectComponent : public USpringArmComponent
{
	GENERATED_BODY()
	
	UFFTP_CarryObjectComponent(const FObjectInitializer& ObjectInitializer);
