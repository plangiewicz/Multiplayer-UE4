...
#include "FFTP_PlayerCameraManager.generated.h"

/**
 * 
 */
UCLASS()
class FURYFUNTALEPROD_API AFFTP_PlayerCameraManager : public APlayerCameraManager
{
	GENERATED_BODY()
	
	AFFTP_PlayerCameraManager(const FObjectInitializer& ObjectInitializer);
